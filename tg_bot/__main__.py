...
PM_START_TEXT = """
ഹായ് {}, എന്റെ പേര് {}! ചക്കരെ എന്നെ ഏതേലും ഗ്രൂപ്പിൽ അഡ്മിൻ ആക്ക്... 🙈
 ആ ഗ്രൂപ്പിന്റെ കാര്യം ഞാൻ നോക്കിക്കോള്ളാം Full On Full Power  😉.
 
@shamilnelli ഇദ്ദേഹം ആണ് എന്റെ ആശാൻ... അങ്ങേർക്ക് വല്ലതും കൊടുക്കണേ...😁

എന്നെ നോക്കി നടത്തുന്നത്  [ഇദ്ദേഹം](tg://user?id={}) ആണ് 
.... ഞാൻ പൂർണമായും opensource ആണ്.. എന്റെ കോഡ് നിങ്ങൾക്ക് [ഇവിടെ](https://heroku.com/deploy?template=https://github.com/shamilhabeebnelli/groupmanager) കാണാവുന്നതാണ്...
...
There are one way of paying him; Google Pay : +919496300461."""
